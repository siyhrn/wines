  ...
  <div class="site-wrap">
          ...
          <div class="mx-auto">
            <nav class="site-navigation position-relative text-left" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none pl-0 d-lg-block border-none">
                ...
                <li><a href="login.html" class="nav-link text-left">Login</a></li>
              </ul>                                                                                                                                                                                                                                                                                         
            </nav>
    ...
    <div class="site-section  pb-0">
      <div class="container">
        ...
        <div class="row mb-5">
          <form action="php/cart_itemAction" class="col-md-12" method="post">
              ...
              <table class="table table-bordered">
               ...
               ?>
                  <tr>
                    ...
                    <img src="upload/<?php echo $row['picture']; ?>" alt="Image" class="img-fluid">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 cart-product-title text-black"><?php echo $row['product'];?></h2>
                    </td>
